...
#define FOREACH_PACKET_TYPE(GENERATOR) \
    ...
    GENERATOR(CZ_SYSTEM_LOG_TO_SERVER, 3617, 1099) \
    ...
    GENERATOR(CZ_ACHIEVE_EQUIP, 3356, 14) \
    GENERATOR(ZC_ACHIEVE_EQUIP, 3357, 22) \
    GENERATOR(CZ_ACHIEVE_REWARD, 3358, 14) \
    GENERATOR(CZ_CHANGE_CONFIG, 3359, 18) \
    GENERATOR(CZ_CHANGE_CONFIG_STR, 3360, 34) \
    GENERATOR(ZC_WORLD_MSG, 3361, 43) \
    GENERATOR(ZC_ENABLE_SHOW_ITEM_GET, 3362, 8) \
    GENERATOR(ZC_LOGIN_TIME, 3363, 14) \
    GENERATOR(ZC_GIVE_EXP_TO_PC, 3364, 42) \
    GENERATOR(ZC_LAYER_PC_LIST, 3365, 0) \
    GENERATOR(ZC_LAYER_PC_SOBJ_PROP, 3366, 0) \
    GENERATOR(CZ_CUSTOM_COMMAND, 3367, 26) \
    GENERATOR(CZ_ADD_HELP, 3522, 14) \
    GENERATOR(ZC_LAYER_INFO, 3368, 10) \
    GENERATOR(CZ_CHAT_MACRO, 3369, 146) \
    GENERATOR(ZC_CHAT_MACRO_LIST, 3370, 0) \
    GENERATOR(ZC_RULLET_LIST, 3371, 0) \
    GENERATOR(ZC_QUICKSLOT_REGISTER, 3372, 46) \
    GENERATOR(CZ_QUICKSLOT_LIST, 3373, 0) \
    GENERATOR(CZ_DOUBLE_ITEM_EQUIP, 3374, 28) \
    GENERATOR(ZC_TRICK_PACKET, 3375, 0) \
    GENERATOR(ZC_COOLDOWN_RATE, 3376, 22) \
    GENERATOR(ZC_MAP_REVEAL_LIST, 3377, 0) \
    GENERATOR(CZ_MAP_REVEAL_INFO, 3378, 146) \
    GENERATOR(CZ_MAP_SEARCH_INFO, 3379, 55) \
    GENERATOR(ZC_UI_INFO_LIST, 3380, 0) \
    GENERATOR(ZC_EXEC_CLIENT_SCP, 3381, 0) \
    GENERATOR(ZC_SET_NPC_STATE, 3382, 18) \
    GENERATOR(ZC_NPC_STATE_LIST, 3383, 0) \
    GENERATOR(CZ_QUEST_NPC_STATE_CHECK, 3384, 14) \
    GENERATOR(ZC_RANK_ACHIEVE_ADD, 3385, 14) \
    GENERATOR(CZ_GET_MAP_REVEAL_ACHIEVE, 3386, 10) \
    GENERATOR(CZ_IES_MODIFY_INFO, 3387, 0) \
    GENERATOR(ZC_IES_MODIFY_INFO, 3388, 0) \
    GENERATOR(ZC_IES_MODIFY_LIST, 3389, 0) \
    GENERATOR(CZ_IES_REVISION_DELETE, 3390, 0) \
    GENERATOR(ZC_IES_REVISION_DELETE, 3391, 0) \
    GENERATOR(ZC_EQUIP_ITEM_REMOVE, 3392, 18) \
    GENERATOR(ZC_SOLD_ITEM_LIST, 3393, 0) \
    GENERATOR(CZ_SOLD_ITEM, 3394, 19) \
    GENERATOR(CZ_WAREHOUSE_CMD, 3395, 31) \
    GENERATOR(CZ_SWAP_ETC_INV_CHANGE_INDEX, 3396, 35) \
    GENERATOR(CZ_SORT_INV, 3397, 12) \
    GENERATOR(CZ_EXTEND_WAREHOUSE, 3398, 10) \
    GENERATOR(CZ_CAST_CONTROL_SHOT, 3399, 10) \
    GENERATOR(ZC_PC_PROP_UPDATE, 3400, 9) \
    GENERATOR(CZ_CLIENT_DAMAGE, 3401, 14) \
    GENERATOR(CZ_CLIENT_ATTACK, 3402, 15) \
    GENERATOR(ZC_SYSTEM_MSG, 3403, 0) \
    GENERATOR(ZC_FSM_MOVE, 3404, 0) \
    GENERATOR(CZ_QUEST_CHECK_SAVE, 3405, 50) \
    GENERATOR(CZ_SPRAY_REQ_INFO, 3406, 14) \
    GENERATOR(CZ_SPRAY_DRAW_INFO, 3407, 0) \
    GENERATOR(ZC_SPRAY_ID, 3408, 18) \
    GENERATOR(ZC_SPRAY_DRAW_INFO, 3409, 0) \
    GENERATOR(ZC_MONSTER_LIFETIME, 3410, 14) \
    GENERATOR(ZC_SPRAY_LIKE_LIST, 3411, 0) \
    GENERATOR(ZC_WIKI_COUNT_UPDATE, 3412, 19) \
    GENERATOR(ZC_WIKI_INT_PROP_UPDATE, 3413, 15) \
    GENERATOR(ZC_WIKI_BOOL_PROP_UPDATE, 3414, 12) \
    GENERATOR(CZ_REQ_WIKI_RANK, 3415, 15) \
    GENERATOR(ZC_WIKI_RANK_LIST, 3416, 0) \
    GENERATOR(ZC_SHARED_MSG, 3417, 10) \
    GENERATOR(CZ_REQ_WIKI_PROP_RANK, 3418, 16) \
    GENERATOR(CZ_REQ_TX_ITEM, 3420, 0) \
    GENERATOR(ZC_TEST_DBG, 3421, 0) \
    GENERATOR(ZC_MONSTER_DIST, 3422, 0) \
    GENERATOR(ZC_RESET_SKILL_FORCEID, 3423, 10) \
    GENERATOR(ZC_EMOTICON, 3424, 18) \
    GENERATOR(ZC_SHOW_EMOTICON, 3425, 18) \
    GENERATOR(ZC_TREASUREMARK_BY_MAP, 3426, 0) \
    GENERATOR(ZC_SHOW_MAP, 3427, 0) \
    GENERATOR(ZC_TREASUREMARK_LIST_MAP, 208, 0) \
    GENERATOR(ZC_FIX_ANIM, 3254, 14) \
    GENERATOR(ZC_MOVE_ANIM, 3257, 12) \
    GENERATOR(CZ_FLEE_OBSTACLE, 3428, 26) \
    GENERATOR(ZC_HOLD_MOVE_PATH, 3429, 11) \
    GENERATOR(ZC_ENTER_HOOK, 3430, 10) \
    GENERATOR(ZC_LEAVE_HOOK, 3431, 10) \
    GENERATOR(ZC_MONSTER_PROPERTY, 3432, 0) \
    GENERATOR(ZC_GROUND_EFFECT, 3433, 50) \
    GENERATOR(ZC_FLY, 3434, 18) \
    GENERATOR(ZC_FLY_MATH, 3435, 22) \
    GENERATOR(ZC_FLY_HEIGHT, 3436, 14) \
    GENERATOR(ZC_UPDATE_SHIELD, 3437, 14) \
    GENERATOR(ZC_SHOW_MODEL, 3438, 15) \
    GENERATOR(ZC_SKILL_RANGE_DBG, 3439, 58) \
    GENERATOR(ZC_SKILL_RANGE_FAN, 3440, 40) \
    GENERATOR(ZC_SKILL_RANGE_SQUARE, 3441, 40) \
    GENERATOR(ZC_SKILL_RANGE_CIRCLE, 3442, 28) \
    GENERATOR(ZC_SKILL_RANGE_DONUTS, 3443, 32) \
    GENERATOR(ZC_TEAMID, 3444, 11) \
    GENERATOR(ZC_PC, 3445, 0) \
    GENERATOR(CZ_LOG, 3446, 0) \
    GENERATOR(ZC_MOTIONBLUR, 3447, 11) \
    GENERATOR(ZC_PLAY_FORCE, 3448, 78) \
    GENERATOR(ZC_CAST_TARGET, 3449, 14) \
    GENERATOR(ZC_START_INFO, 3450, 0) \
    GENERATOR(ZC_JOB_EXP_UP, 3451, 10) \
    GENERATOR(ZC_JOB_PTS, 3452, 10) \
    GENERATOR(ZC_MON_STAMINA, 3453, 22) \
    GENERATOR(CZ_CUSTOM_SCP, 3454, 14) \
    GENERATOR(ZC_VIEW_FOCUS, 3455, 24) \
    GENERATOR(ZC_HARDCODED_SKILL, 3456, 26) \
    GENERATOR(CZ_HARDCODED_SKILL, 3457, 34) \
    GENERATOR(ZC_FORCE_MOVE, 3458, 30) \
    GENERATOR(ZC_HSKILL_CONTROL, 3459, 22) \
    GENERATOR(ZC_CANCEL_DEADEVENT, 3460, 10) \
    GENERATOR(ZC_ACTION_PKS, 3461, 35) \
    GENERATOR(CZ_HARDCODED_ITEM, 3462, 22) \
    GENERATOR(CZ_BRIQUET, 3464, 30) \
    GENERATOR(CZ_CANCEL_TRANSFORM_SKILL, 3463, 10) \
    GENERATOR(ZC_VIBRATE, 3465, 30) \
    GENERATOR(ZC_COUNTER_MOVE, 3466, 10) \
    GENERATOR(CZ_COUNTER_ATTACK, 3467, 14) \
    GENERATOR(CZ_CLIENT_DIRECT, 3468, 30) \
    GENERATOR(ZC_CLIENT_DIRECT, 3469, 30) \
    GENERATOR(ZC_OWNER, 3470, 14) \
    GENERATOR(ZC_GD_RANK, 3471, 10) \
    GENERATOR(CZ_RUN_BGEVENT, 3472, 74) \
    GENERATOR(ZC_ADD_SKILL_EFFECT, 3473, 18) \
    GENERATOR(ZC_ITEM_DROPABLE, 3474, 10) \
    GENERATOR(CZ_ITEM_DROP_TO_OBJECT, 3475, 26) \
    GENERATOR(ZC_NORMAL, 3476, 0) \
    GENERATOR(CZ_G_QUEST_CHECK, 3477, 14) \
    GENERATOR(ZC_MOVE_PATH_MATH, 3478, 30) \
    GENERATOR(ZC_SHOW_GROUND_ITEM_MARK, 3495, 30) \
    GENERATOR(ZC_HELP_LIST, 3496, 0) \
    GENERATOR(ZC_HELP_ADD, 3497, 11) \
    GENERATOR(ZC_STD_ANIM, 3258, 11) \
    GENERATOR(CZ_CLIENT_HIT_LIST, 3498, 0) \
    GENERATOR(ZC_PC_ATKSTATE, 3499, 11) \
    GENERATOR(ZC_SEND_PREMIUM_STATE, 3500, 8) \
    GENERATOR(CZ_HELP_READ_TYPE, 3501, 18) \
    GENERATOR(CZ_MOVE_PATH_END, 3502, 10) \
    GENERATOR(ZC_COLL_DAMAGE, 3503, 11) \
    GENERATOR(CZ_KEYBOARD_BEAT, 3504, 10) \
    GENERATOR(CZ_MOVEHIT_SCP, 3505, 22) \
    GENERATOR(ZC_SYNC_START, 3506, 10) \
    GENERATOR(ZC_SYNC_END, 3507, 14) \
    GENERATOR(ZC_SYNC_EXEC, 3508, 10) \
    GENERATOR(ZC_SYNC_EXEC_BY_SKILL_TIME, 3509, 18) \
    GENERATOR(CZ_STOP_TIMEACTION, 3510, 11) \
    GENERATOR(CZ_REQ_DUMMYPC_INFO, 3511, 18) \
    GENERATOR(CZ_VISIT_BARRACK, 3512, 74) \
    GENERATOR(CZ_SPC_SKILL_POS, 3513, 22) \
    GENERATOR(CZ_REQ_CHANGEJOB, 3514, 14) \
    GENERATOR(CZ_REQ_MINITEXT, 3517, 266) \
    GENERATOR(ZC_PC_MOVE_STOP, 3518, 35) \
    GENERATOR(CZ_SKILL_TOOL_GROUND_POS, 3528, 26) \
    GENERATOR(CZ_CHANGE_HEAD, 3515, 74) \
    GENERATOR(CZ_CREATE_ARROW_CRAFT, 3516, 14) \
    GENERATOR(CZ_PLAY_HISTORY, 3292, 19) \
    GENERATOR(CZ_HISTORY_ROLL_BACK, 3293, 271) \
    GENERATOR(CZ_MYPAGE_COMMENT_ADD, 3479, 278) \
    GENERATOR(CZ_MYPAGE_COMMENT_DELETE, 3480, 18) \
    GENERATOR(CZ_GET_TARGET_MYPAGE, 3482, 14) \
    GENERATOR(CZ_ON_MYPAGE_MODE, 3483, 14) \
    GENERATOR(CZ_RESET_SOCIAL_MODE, 3484, 10) \
    GENERATOR(CZ_GUESTPAGE_COMMENT_ADD, 3481, 278) \
    GENERATOR(CZ_GET_TARGET_GUESTPAGE, 3485, 14) \
    GENERATOR(CZ_ADD_SELLMODE_ITEM, 3486, 30) \
    GENERATOR(CZ_DELETE_SELLMODE_ITEM, 3487, 18) \
    GENERATOR(CZ_ON_SELLITEM_MODE, 3488, 14) \
    GENERATOR(CZ_ON_ITEMBUY_MODE, 3493, 0) \
    GENERATOR(ZC_MYPAGE_MAP, 3489, 0) \
    GENERATOR(ZC_GUESTPAGE_MAP, 3490, 0) \
    GENERATOR(ZC_ON_MYPAGE_MODE, 3491, 0) \
    GENERATOR(ZC_RESET_SOCIAL_MODE, 3492, 10) \
    GENERATOR(ZC_ON_BUYITEM_MODE, 3494, 0) \
    GENERATOR(CZ_STOP_ALLPC, 3519, 10) \
    GENERATOR(CZ_COMPLETE_PRELOAD, 3520, 14) \
    GENERATOR(CZ_MGAME_JOIN_CMD, 3521, 46) \
    GENERATOR(ZC_ATTACH_TO_OBJ, 3523, 49) \
    GENERATOR(ZC_DETACH_FROM_OBJ, 3524, 14) \
    GENERATOR(ZC_RUN_FROM, 3525, 14) \
    GENERATOR(ZC_LOOKAT_OBJ, 3526, 14) \
    GENERATOR(CZ_SKILL_CELL_LIST, 3527, 0) \
    GENERATOR(CZ_DIRECTION_PROCESS, 3529, 18) \
    GENERATOR(CZ_DIRECTION_MOVE_STATE, 3530, 0) \
    GENERATOR(ZC_TO_ALL_CLIENT, 3531, 0) \
    GENERATOR(ZC_TO_CLIENT, 3532, 0) \
    GENERATOR(CZ_REWARD_CMD, 3533, 14) \
    GENERATOR(CZ_PROPERTY_COMPARE, 3534, 16) \
    GENERATOR(ZC_PROPERTY_COMPARE, 3535, 0) \
    GENERATOR(ZC_SEND_CASH_VALUE, 3537, 0) \
    GENERATOR(ZC_RECOMMEND_PARTYMEMBER_INFO, 3604, 0) \
    GENERATOR(ZC_FACTION, 3536, 14) \
    GENERATOR(ZC_BEGIN_KILL_LOG, 3538, 6) \
    GENERATOR(ZC_END_KILL_LOG, 3539, 6) \
    GENERATOR(ZC_CLEAR_KILL_LOG, 3540, 6) \
    GENERATOR(CZ_NPC_AUCTION_CMD, 3541, 30) \
    GENERATOR(ZC_DIRECTION_APC, 3542, 26) \
    GENERATOR(ZC_BGMODEL_ANIM_INFO, 3543, 15) \
    GENERATOR(ZC_ATTACH_BY_KNOCKBACK, 3544, 38) \
    GENERATOR(CZ_OBJECT_MOVE, 3545, 30) \
    GENERATOR(CZ_CONTROL_OBJECT_ROTATE, 3546, 22) \
    GENERATOR(CZ_SUMMON_COMMAND, 3547, 18) \
    GENERATOR(CZ_VEHICLE_RIDE, 3548, 15) \
    GENERATOR(CZ_REQ_WIKI_CATEGORY_RANK_PAGE_INFO, 3549, 78) \
    GENERATOR(CZ_REQ_ACHIEVE_RANK_PAGE_INFO, 3550, 78) \
    GENERATOR(CZ_REQ_MONSTER_RANK_INFO, 3551, 74) \
    GENERATOR(ZC_SPC_TRIGGER_EXEC, 3552, 30) \
    GENERATOR(CZ_REQ_MGAME_VIEW, 3553, 18) \
    GENERATOR(CZ_REQ_MGAME_CHAT, 3554, 0) \
    GENERATOR(CZ_TOURNAMENT_GIFT, 3555, 18) \
    GENERATOR(CZ_PARTY_INVITE_ACCEPT, 3556, 79) \
    GENERATOR(CZ_PARTY_INVITE_CANCEL, 3557, 83) \
    GENERATOR(CZ_PARTY_PROP_CHANGE, 3558, 145) \
    GENERATOR(CZ_REQ_MARKET_REGISTER, 3559, 40) \
    GENERATOR(CZ_REQ_MARKET_MINMAX_INFO, 3560, 18) \
    GENERATOR(CZ_REQ_MARKET_BUY, 3561, 0) \
    GENERATOR(CZ_REQ_MARKET_LIST, 3562, 162) \
    GENERATOR(CZ_REQ_MY_SELL_LIST, 3563, 14) \
    GENERATOR(CZ_REQ_CABINET_LIST, 3564, 10) \
    GENERATOR(CZ_REQ_GET_CABINET_ITEM, 3565, 26) \
    GENERATOR(CZ_REQ_CANCEL_MARKET_ITEM, 3566, 18) \
    GENERATOR(CZ_OBJ_RECORD_POS, 3568, 0) \
    GENERATOR(CZ_FORMATION_CMD, 3569, 32) \
    GENERATOR(CZ_REGISTER_AUTOSELLER, 3570, 0) \
    GENERATOR(CZ_INV_ITEM_LOCK, 3567, 19) \
    GENERATOR(CZ_OPEN_AUTOSELLER, 3571, 34) \
    GENERATOR(CZ_BUY_AUTOSELLER_ITEMS, 3572, 0) \
    GENERATOR(CZ_SELL_MY_AUTOSELLER_ITEMS, 3573, 0) \
    GENERATOR(CZ_PUZZLE_CRAFT, 3574, 0) \
    GENERATOR(CZ_GET_WIKI_REWARD, 3419, 11) \
    GENERATOR(CZ_PET_EQUIP, 3575, 30) \
    GENERATOR(ZC_FOUND_PARTY_LIST, 3576, 0) \
    GENERATOR(ZC_NEAR_PARTY_LIST, 3577, 0) \
    GENERATOR(ZC_RECOMMEND_PARTY_INFO, 3578, 0) \
    GENERATOR(CZ_REQUEST_SOME_PARTY, 3579, 90) \
    GENERATOR(CZ_REFRESH_MEMBERRECOMMEND_LIST, 3580, 10) \
    GENERATOR(ZC_TO_SOMEWHERE_CLIENT, 3581, 0) \
    GENERATOR(CZ_REVEAL_NPC_STATE, 3582, 14) \
    GENERATOR(CZ_CHANGE_CHANNEL, 3583, 12) \
    GENERATOR(CZ_REQ_CHANNEL_TRAFFICS, 3584, 12) \
    GENERATOR(CZ_BUY_PROPERTYSHOP_ITEM, 3585, 0) \
    GENERATOR(CZ_SKILL_USE_HEIGHT, 3586, 14) \
    GENERATOR(CZ_ACCEPT_PARTY_QUEST, 3587, 20) \
    GENERATOR(CZ_ACCEPT_GUILD_EVENT, 3588, 20) \
    GENERATOR(CZ_ACCEPT_GUILD_EVENT_RAID, 3589, 20) \
    GENERATOR(CZ_ACCEPT_PARTY_EVENT, 3590, 20) \
    GENERATOR(CZ_DELETE_PARTY_EVENT, 3591, 20) \
    GENERATOR(CZ_PING, 3592, 10) \
    GENERATOR(ZC_PING, 3593, 10) \
    GENERATOR(ZC_XIGNCODE_BUFFER, 3594, 524) \
    GENERATOR(CZ_XIGNCODE_BUFFER, 3595, 524) \
    GENERATOR(CZ_SYSTEM_LOG_SAVE_TO_MONGODB, 3596, 280) \
    GENERATOR(CZ_CHANGE_TITLE, 3597, 74) \
    GENERATOR(CZ_PC_COMMENT_CHANGE, 3598, 0) \
    GENERATOR(CZ_AUTTOSELLER_BUYER_CLOSE, 3599, 18) \
    GENERATOR(CZ_REQ_ITEM_LIST, 3600, 11) \
    GENERATOR(CZ_HIT_MISSILE, 3601, 14) \
    GENERATOR(CZ_I_NEED_PARTY, 3602, 23) \
    GENERATOR(CZ_PARTY_JOIN_BY_LINK, 3603, 19) \
    GENERATOR(CZ_PVP_ZONE_CMD, 3605, 22) \
    GENERATOR(CZ_PVP_CHAT, 3606, 0) \
    GENERATOR(CZ_CARDBATTLE_CMD, 3607, 26) \
    GENERATOR(CZ_REQ_UPDATE_CONTENTS_SESSION, 3608, 10) \
    GENERATOR(CZ_REQ_FRIENDLY_FIGHT, 3609, 15) \
    GENERATOR(CZ_HARDSKILL_POS_LIST, 3610, 0) \
    GENERATOR(CZ_CART_POSITION, 3611, 26) \
    GENERATOR(CZ_REQ_RIDE_CART, 3612, 18) \
    GENERATOR(CZ_DUMMYPC_SKILL_POS, 3613, 26) \
    GENERATOR(CZ_PARTY_MEMBER_SKILL_USE, 3615, 0) \
    GENERATOR(CZ_PARTY_MEMBER_SKILL_ACCEPT, 3616, 22) \
    GENERATOR(CZ_CHECK_PING, 3618, 10) \
